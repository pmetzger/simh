...
If you want to work with the emulator source code, build it from the
ZIMH CMake tree. The IBM 1130 utility programs have CMake build-check
targets, but they are not installed with the simulator binaries yet.
...
5.  Use the ZIMH CMake build to build the emulator.

6.  To check that the IBM 1130 accessory programs still build, run
    `cmake --build <build-dir> --target ibm1130-utils`. These utilities
    are build-check targets and are not installed yet.
...
3.  Use the ZIMH CMake build to build the emulator.

4.  To check that the IBM 1130 accessory programs still build, run
    `cmake --build <build-dir> --target ibm1130-utils`. These utilities
    are build-check targets and are not installed yet.
